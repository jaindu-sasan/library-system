...
import LibrarianProfileBar from './LibrarianProfileBar';

const navItems = [
  { text: 'Dashboard', path: '/librarian' },
  { text: 'Add Book', path: '/librarian/add-book' },
  { text: 'Manage Users', path: '/librarian/manage-users' },
  { text: 'Book Inventory', path: '/librarian/book-inventory' },
];
